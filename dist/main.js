    ...
    function loadProject(project) {
        ...
        addButton.addEventListener("click", () => {
            ...
            confirmTodoButton.addEventListener("click", (e) => {
                ...
                const todoDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(dateString), "MM/dd/yyyy");
                const todoPriority = document.querySelector("#todo-priority").checked;

                const newTodo = new _todo_js__WEBPACK_IMPORTED_MODULE_2__.todo(todoName, todoDescription, todoDate, todoPriority);
